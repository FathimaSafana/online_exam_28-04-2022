<%@page import="project.Questions"%>
<%@page import="java.util.ArrayList"%>
<jsp:useBean id="pDAO" class="project.DatabaseClass" scope="page" />
		...
		<div class="question-panel">
			<div class="question">
				...
				<a href="controller.jsp?page=questions&operation=delQuestion&qid=<%=question.getQuestionId()%>"
				 onclick="return confirm('Are you sure you want to delete this ?');" class="del">delete
					<div class="delete-btn" style="position: absolute; right: 10px; top: -20px;"></div>
				</a>
			</div>
			<div class="answer">
